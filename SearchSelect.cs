...
namespace LibraryApp
{
    public partial class SearchSelect : Form
    {
        ...
        public SearchSelect(Main parent, String NewText, String NewDescription, String NewRec1, String NewRec2, String NewRec3, String NewRec4, String NewRec5)
        {
            InitializeComponent();
            pf = parent;
            this.Height = 370;
        ...
        {
            Search SupportingClassAddForm = new Search(this, Description, "Add", "");
        ...
        {
            Search SupportingClassAddForm = new Search(this, Description, "Edit", txtRec5.Text);
            SupportingClassAddForm.Show();
            SupportingClassAddForm.MdiParent = pf;
        }
